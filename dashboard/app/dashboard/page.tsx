                  ...
                  {view === "overview" ? (
                    <>
                      ...
                      <button
                        ...
                        className="h-10 rounded-xl bg-linear-to-r from-cyan-500 to-indigo-500 px-4 text-sm font-semibold text-white shadow-[0_10px_30px_rgba(59,130,246,0.35)] transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-60"
          ...
          <div className="mx-auto max-w-6xl px-6 py-8">
            ...
            {view === "overview" ? (
              ...
              <div className="mt-8 grid gap-6">
                <div className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)] backdrop-blur">
                  ...
                  <div className="mt-4 grid gap-4 md:grid-cols-2">
                    ...
                    <div className="flex items-end">
                      <button
                        ...
                        className="h-10 w-full rounded-xl bg-linear-to-r from-cyan-500 to-indigo-500 px-4 text-sm font-semibold text-white shadow-[0_10px_30px_rgba(59,130,246,0.35)] transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-60"
